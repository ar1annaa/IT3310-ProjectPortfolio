...
**Tech Comfort Level:** High, learns new software quickly

---

### Primary Work Goal
Support patients with issues they experience on the intake platform.

---

### Main Frustration with the Current System
Marie is frustrated by the amount of tickets and calls received a day about issues patients have with scheduling appointments, on average her team gets 20+ patient requests a day.

---

### What Would Make Their Work Better
Having an improved intake system will make the ticket workload easier, without the repetitive troubleshooting calls and manual booking requests bringing down team's daily schedule.

---

## Product Vision Statement
For IT support staff who receive 20+ intake and scheduling tickets a day, a unified scheduling system will reduce recurring support requests about appointment confirmation so IT staff can spend more time on higher-priority work.
